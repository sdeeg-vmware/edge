...
$VCSAInstallerPath = "G:\"
$NSXTManagerOVA = "C:\Users\Administrator\Downloads\TKGS7u3_bits\controller-21.1.2-9124.ova"
$NSXTEdgeOVA = "C:\Users\Administrator\Downloads\TKGS7u3_bits\controller-21.1.2-9124.ova"
$TKGIOVA = "C:\Users\Administrator\Downloads\TKGS7u3_bits\controller-21.1.2-9124.ova"

# Nested ESXi VMs to deploy
$NestedESXiHostnameToIPs = @{
    "avi-esxi-7" = "192.168.3.47"
    "avi-esxi-8" = "192.168.3.48"
    "avi-esxi-9" = "192.168.3.49"
}

# Nested ESXi VM Resources
$NestedESXivCPU = "8"
$NestedESXivMEM = "45" #GB
$NestedESXiCachingvDisk = "8" #GB
$NestedESXiCapacityvDisk = "110" #GB

# VCSA Deployment Configuration
$VCSADeploymentSize = "tiny"
$VCSADisplayName = "vcenteravi"
$VCSAIPAddress = "192.168.3.50"
$VCSAHostname = "vcenteravi.lab.local" #Change to IP if you don't have valid DNS
$VCSAPrefix = "24"
...
$VMDatacenter = "Orf_DC1"
$VMCluster = "Orf_CL1"
$VMNetwork = "Priv_79_192_168"
$VMDatastore = "Texas_DS"
$VMNetmask = "255.255.255.0"
$VMGateway = "192.168.3.1"
$VMDNS = "10.197.79.7"
$VMNTP = "10.128.152.81"
$VMPassword = "VMware1!"
$VMDomain = "lab.local"
$VMSyslog = "192.168.3.50"
$VMFolder = "Project-AVI-c"
# Applicable to Nested ESXi only
$VMSSH = "true"
$VMVMFS = "false"

#TKGI console setup
$TKGIDatastore = "vsanDatastore3c"
$TKGIPKSConsoleName = "avi_controller"
$TKGIrootpwd = "VMware1!"
$TKGIip = "192.168.3.40"
$TKGImask = "255.255.255.0"
$TKGIgw = "192.168.3.1"
$TKGIdns = "10.197.79.7"
$TKGIsearchpath = "lab.local"
$TKGIfqdn = "avi.lab.local"


# Name of new vSphere Datacenter/Cluster when VCSA is deployed
$NewVCDatacenterName = "avi-Datacenter"
$NewVCVSANClusterName = "avi-Cluster3c"
$NewVCVDSName = "Pacific-VDSb"
$NewVCDVPGName1 = "DVPG-Management Network3c"
$NewVCDVPGName2 = "DVPG-Frontend Network3c"
$NewVCDVPGName3 = "DVPG-Workload Network3c"
...
# NSX-T Configuration
$NSXLicenseKey = "8N035-JLL82-T8KD9-05C0H-ADTJ0"
...
$T0GatewayInterfaceAddress = "192.168.10.56" # should be a routable address
...
$T0GatewayInterfaceStaticRouteAddress = "192.168.10.1"
...
$NSXTMgrDeploymentSize = "large"
$NSXTMgrvCPU = "8" #override default size
$NSXTMgrvMEM = "32" #override default size
$NSXTMgrDisplayName = "tkgi-nsx-ua"
$NSXTMgrHostname = "tkgi-nsx-ua.tkgi.local"
$NSXTMgrIPAddress = "192.168.10.54"
...
$NSXTEdgeHostnameToIPs = @{
    "tkgi-nsx-edge1" = "192.168.10.55";
    "tkgi-nsx-edge2" = "192.168.10.56"
}
...
$debug = $true
$verboseLogFile = "AVI-deploymenttkgiclusterb.log"
$random_string = -join ((65..90) + (97..122) | Get-Random -Count 8 | % {[char]$_})
$VAppName = "AVI-Nested-Lab-b-$random_string"
...
if($preCheck -eq 1) {
	#orf $TKGIOVA
    if(!(Test-Path $TKGIOVA)) {
        Write-Host -ForegroundColor Red "`nUnable to find $TKGIOVA ...`nexiting"
        exit
    }
    ...
    if($NSXLicenseKey -eq "") {
        Write-Host -ForegroundColor Red "`nNSX-T License is required, please fill out `$NSXLicenseKey variable...`nexiting"
        exit
    }
}
...
#orf
if( $deployTKGI -eq 1 -or $deployNestedESXiVMs -eq 1 -or $deployVCSA -eq 1 -or $deployNSXManager -eq 1 -or $deployNSXEdge -eq 1) {
...
if($deployTKGI -eq 1) {
    # Deploy AVI 
    $datastore2 = Get-Datastore -Server $viConnection -Name $TKGIDatastore | Select -First 1

    $tkgiMgrOvfConfig = Get-OvfConfiguration $TKGIOVA
	$tkgiMgrOvfConfig.avi.CONTROLLER.mgmt_ip.Value = $TKGIip
	$tkgiMgrOvfConfig.avi.CONTROLLER.mgmt_mask.Value = $TKGImask
	$tkgiMgrOvfConfig.avi.CONTROLLER.default_gw.Value = $TKGIgw
	$tkgiMgrOvfConfig.avi.CONTROLLER.sysadmin_public_key.Value = ""
	$tkgiMgrOvfConfig.NetworkMapping.Management.Value = $NewVCDVPGName1
	
 
    My-Logger "Deploying AVI COntroller Console VM  ..."
    $tkgimgr_vm = Import-VApp -Source $TKGIOVA -OvfConfiguration $tkgiMgrOvfConfig -Name $TKGIPKSConsoleName -Location $cluster -VMHost $vmhost -Datastore $datastore2 -DiskStorageFormat thin
    My-Logger "Powering On $TKGIPKSConsoleName ..."
    $tkgimgr_vm | Start-Vm -RunAsync | Out-Null
...
if($deployVCSA -eq 1) {
        ...
        if($IsWindows) {
            ...
            My-Logger "Deploying the VCSA ...1"
        } elseif($IsMacOS) {
            My-Logger "Creating VCSA JSON Configuration file for deployment ..."
...
if($deployAVI -eq 1) {
    ...
    $datastore2 = Get-Datastore -Server $vc -Name $TKGIDatastore | Select -First 1
